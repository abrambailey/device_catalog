Goodstyles::Application.routes.draw do
  resources :styles
	resources :submodels
	resources :models
	resources :brands
	
	match 'brandsubmit', to: 'styles#brandsubmit'
	match 'modelsubmit', to: 'styles#modelsubmit'
	match 'submodelsubmit', to: 'styles#submodelsubmit'
	match 'selectmodels', to: 'models#selectmodels'
